...
document.getElementById("lancement").addEventListener("click", function(){
    ...
    lancement.addEventListener("click", function(){
        texte.innerText = `Vous allez pouvoir définir le nom de vos personnages`;

        lancement.addEventListener("click", function(){
        // définition du nom des personnages

            lancement.id = "lancement2";
            ...
            lancement2.addEventListener("click", function(){
                // définition point de vie

                let ptVie = 800;

                texte.innerText= `Vous avez nommé vos personnages ${guerrier.nom}, ${mage.nom} et ${archer.nom}. Vous allez maintenant pouvoir leur distribuer ${Math.floor(ptVie)} points de vie`;
